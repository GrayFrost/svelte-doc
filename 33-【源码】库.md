...
![[Pasted image 20240327101906.png]]

![[Pasted image 20240327101927.png]]
...
```
![[Pasted image 20240327102832.png]]

#### replace
`this.replace()`方法演示：
比如我们想把`let a = 0;`改成`let a = 1;`，0对应的是`Literal`的节点
![[Pasted image 20240327103417.png]]
...
![[Pasted image 20240327103518.png]]
